...
osThreadId SemaphoTask2Handle;
osSemaphoreId hBinarySem01Handle;
...
/* USER CODE BEGIN Header_SemaTask */
/**
* @brief Function implementing the SemaphoTask2 thread.
* @param argument: Not used
* @retval None
*/
